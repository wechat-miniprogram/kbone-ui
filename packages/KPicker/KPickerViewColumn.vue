<template>
    ...
    <KView v-else  class="weui-picker__group" ref="container">
        <KView class="weui-picker__mask"></KView>
        <KView class="weui-picker__indicator" ref="indicator"></KView>
        <KView class="weui-picker__content" ref="content">
            <slot>
            </slot>
        </KView>
    </KView>
...
export default {
  ...
  methods: {
    ...
    stop(diff) {
      ...
      // TODO 支持 disabled 选项
      let index = this.offset - this.translate / this.itemHeight
