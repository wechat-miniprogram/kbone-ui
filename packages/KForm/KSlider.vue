<template>
    <KView v-if="!ismp" class="weui-slider-box" >
        <KView class="weui-slider">
            <KView class="weui-slider__inner" ref="trackbar" >
                <KView class="weui-slider__track" 
                    :style="{width: stopPosition + '%'}" />
                <KView class="weui-slider__handler" :style="{left: stopPosition + '%'}"
        ...
        <KView v-if="showValue" class="weui-slider-box__value">{{stopPosition}}</KView>
    </KView>
    <wx-slider 
      :min="min"
      :max="max"
